...
EndGame.prototype.draw = function (ctx) {
    ...
    for (var i = 0, len = this.pfData.length; i < len; i++) {
        ...
        drawTextWithOutline(ctx, "28pt Impact", currPFDataObj.ranking, currPFDataObj.x + 35, currPFDataObj.y + 40,
    ...
    for (var i = 0, len = this.goatData.length; i < len; i++) {
        ...
        drawTextWithOutline(ctx, "20pt Impact", wins, currGoatData.x, currGoatData.y + 170, currGoatData.color, 'white');
        drawTextWithOutline(ctx, "20pt Impact", total, currGoatData.x, currGoatData.y + 200, currGoatData.color, 'white');
        drawTextWithOutline(ctx, "20pt Impact", best, currGoatData.x, currGoatData.y + 230, currGoatData.color, 'white');
    }
